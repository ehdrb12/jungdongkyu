...
<%-- 자바주석시작   
- jsp에서 자바프로그램을 사용할 떄 쓰는 태그 <% %> 감싸주게 됩니다.
- 다른언어 PHP예를 들면 <?php ?>로 감싸주게 됩니다.
- @page골뱅이는 애노테이션발음-페이지지시자는 필수입니다. 랭귀지:java,
- 콘텐츠타입:text/html;문자셋:유니코드 페이지인코딩:유니코드
자바주석 끝 --%>

<!-- HomeController.java 에서 index.jsp로 매칭 시킨 결과가 나오는 페이지 입니다.
- 왜 /resources/sample/index.html 이렿게 접근하지 않고,
- jsp프로그램에서는 위홈컨트롤러자바를 거쳐서 index.jsp를 접근하는 이유는 보안때문 입니다.
...
- 자바에서 출발한 스프링프레입워크는: 자바에서 웹프로그램 만드는데 특화된 라이브러리(프로그램묶음)를 구조하 시
- 개발자가 편하게 만들어 놓은것이 스프링프레임워크.(현재는 버전5.x, 우리는4.3.22버전 사용예정)
- 그러면, jsp는 뭐냐: 지금 보이는 프로젝트는 스프링MVC프로젝트 입니다.
- 여기서 MVC에서 View단에 해당하는 기술 부분이 jsp입니다.
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/resources/sample/img/bper.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/resources/sample/img/san.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/resources/sample/img/bag.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
