...
public class Step3 {
	...
	public static void main(String[] args) {
		// 메인 메서드-스레드 시작.
		Week today= null;//Week자료형용 today변수/선언
		//String today2 = null;//String자료형용 today2변수생성
		//MemberVO memberVO = new MemberVO();
		//MemberVO자료형용 memberVO객체/오브젝트변수 선언
		...
		case 3:
			today = Week.화; break;//Week자료형에 바로접근하는 밥법 Week.
		case 4:
			today = Week.수; break;
		case 5:
			today = Week.목; break;
		...
		//Calendar클래스는 달력에서 날짜, 본인 컴퓨처 날짜라서, 본인 컴퓨터 날짜라서 사용자가 날짜르 수정하면 원하는 결과가 안 나옵니다.
		//이 때 해결책은 서버 시간을 가져와서 출력하면, 사용자가 날짜를 수정 못하게 됩니다.
	}
